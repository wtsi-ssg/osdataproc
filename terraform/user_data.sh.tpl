...
ansible-pull ansible/main.yml -C $BRANCH -U $REPO -fi localhost -e ansible_python_interpreter=/usr/bin/python3 -e spark_master_private_ip=${spark_master_private_ip} -e netdata_api_key=${netdata_api_key} --skip-tags=master
