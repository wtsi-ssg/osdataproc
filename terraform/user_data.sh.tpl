...
ansible-playbook /tmp/osdataproc/ansible/main.yml -i localhost -e ansible_python_interpreter=/usr/bin/python3 -e spark_master_private_ip=${spark_master_private_ip} -e netdata_api_key=${netdata_api_key} -e nfs_volume=${nfs_volume} -e '@/tmp/osdataproc/vars.yml' --skip-tags=master
